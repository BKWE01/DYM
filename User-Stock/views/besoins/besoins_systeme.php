                            ...
                            <?php if (isset($besoins) && is_array($besoins) && count($besoins) > 0): ?>
                                <?php foreach ($besoins as $besoin): ?>
                                    <tr>
                                        ...
                                        <td><?= isset($besoin['date_demande']) ? date('d/m/Y', strtotime($besoin['date_demande'])) : 'Non spécifié' ?></td>
                                        <td>
                                        ...
                                        <td>
                                            <a href="../../expression_syst_pdf.php?id=<?= htmlspecialchars($besoin['idBesoin']) ?>" target="_blank" class="view-pdf-btn">
