    ...
    <div class="wrapper">
        ...
        <main class="flex-1 p-6">
            ...
            <div class="top-bar p-4 mb-6 flex flex-col md:flex-row justify-between items-center gap-4">
                <a href="../expressions/index.php" class="text-decoration-none">
                    ...
                    const table = $(`#${period}-table`).DataTable({
                        ...
                        columns: [
                            ...
                            },
                            {
                                data: null,
                                render: function(data, type, row) {
                                    return `<a href="../../api/pdf/expression_syst_pdf.php?id=${row.idBesoin}" target="_blank" class="view-btn">
