...
// Charger la configuration de manière sécurisée
$config_file = __DIR__ . '/../components/config.php';
if (file_exists($config_file)) {
    require_once $config_file;
    $base_url = defined('PROJECT_ROOT') ? PROJECT_ROOT : '';
} else {
    // Fallback si le fichier config n'existe pas
    /*$base_url = '/DYM MANUFACTURE/expressions_besoins';
