...
/**
 * Remplir le formulaire avec les données existantes - MISE À JOUR pour les icônes
 */
function populateForm(data) {
    ...
    // NOUVEAU : Gestion de l'icône actuelle
    currentIconPath = data.icon_path;
    
    if (data.icon_info && data.icon_info.has_custom_icon && data.icon_info.icon_exists) {
