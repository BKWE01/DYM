<?php
/**
 * get_finance_stats.php
 * API pour récupérer les statistiques du service Finance
 * 
...
try {
    ...
    $response = $financeController->getFinanceStats();
    ...
    $financeController->logFinanceAction(
        ...
        'view_stats', 
        0, 
        ['stats_loaded' => $response->isSuccess()]
    );
    ...
    error_log("Erreur API get_finance_stats: " . $e->getMessage());
    
    ApiResponse::error(
        'Erreur technique lors de la récupération des statistiques',
